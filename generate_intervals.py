...
from musicxml_utils import first_n_notes_in_measure, note_pitch, set_note_pitch, pitch_to_midi, midi_to_pitch, INTERVAL_TO_SEMITONES, write_tree
def main():
    ap = argparse.ArgumentParser(description="Set the 2nd note at a chosen interval from the 1st across the entire file.")
